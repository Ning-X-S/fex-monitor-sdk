(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["jarvis-sdk"] = factory();
	else
		root["jarvis-sdk"] = factory();
})(window, function() {
...
var $ = __webpack_require__(4);
var $padStart = __webpack_require__(132).start;
...
var es_object_get_own_property_descriptors = __webpack_require__(39);
...
var es_string_replace = __webpack_require__(41);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.string.split.js
var es_string_split = __webpack_require__(42);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.string.trim.js
var es_string_trim = __webpack_require__(87);

// EXTERNAL MODULE: ./node_modules/core-js/modules/web.dom-collections.for-each.js
var web_dom_collections_for_each = __webpack_require__(20);

// EXTERNAL MODULE: ./node_modules/regenerator-runtime/runtime.js
var runtime = __webpack_require__(91);

// EXTERNAL MODULE: ./src/config/version.json
var version = __webpack_require__(97);

// CONCATENATED MODULE: ./src/util/caniuse.js
...
function supportPerformanceClearResource() {
  return !!(window.performance && window.performance.clearResourceTimings);
}
var isSupportPerformanceObserver = 'PerformanceObserver' in window && typeof PerformanceObserver === 'function';
// CONCATENATED MODULE: ./src/lib/performance/resource.js
...
function getAllResourceTiming() {
  var resourceTimingList = [];

  if (supportPerformanceEntry) {
    resourceTimingList = performance.getEntriesByType('resource').map(function (source) {
      return _objectSpread({}, getResourceTiming(source));
    });
  }
...
function getResourceTiming(_ref) {
  var name = _ref.name,
      nextHopProtocol = _ref.nextHopProtocol,
      type = _ref.type,
      duration = _ref.duration,
      redirectEnd = _ref.redirectEnd,
      redirectStart = _ref.redirectStart,
      domainLookupStart = _ref.domainLookupStart,
      domainLookupEnd = _ref.domainLookupEnd,
      fetchStart = _ref.fetchStart,
      connectEnd = _ref.connectEnd,
      connectStart = _ref.connectStart,
      secureConnectionStart = _ref.secureConnectionStart,
...
// CONCATENATED MODULE: ./src/lib/performance/navigation.js
...
var navigation_performance = window.performance;

function performanceTiming() {
  return supportPerformanceEntry() ? navigation_performance.getEntriesByType('navigation')[0] : navigation_performance.timing;
}

function getNormalNavigationTiming() {
  ...
  var timingObj = navigation_objectSpread(navigation_objectSpread({}, getResourceTiming(timing)), {}, {
    // DOM 解析耗时
...
function getAdvancedNavigationTiming() {
  return new Promise(function (resolve) {
    ...
    if (supportPerformanceEntry()) {
      ...
      advancedData.FP = ((_performance$getEntri = navigation_performance.getEntriesByName('first-paint')) === null || _performance$getEntri === void 0 ? void 0 : (_performance$getEntri2 = _performance$getEntri[0]) === null || _performance$getEntri2 === void 0 ? void 0 : _performance$getEntri2.startTime) || -1;
      advancedData.FCP = ((_performance$getEntri3 = navigation_performance.getEntriesByName('first-contentful-paint')) === null || _performance$getEntri3 === void 0 ? void 0 : (_performance$getEntri4 = _performance$getEntri3[0]) === null || _performance$getEntri4 === void 0 ? void 0 : _performance$getEntri4.startTime) || -1; // 增加一个性能条目的观察者

      var elementObserve = new PerformanceObserver(function (entryList, observer) {
        var _perfEntries$;

        var perfEntries = entryList.getEntries();
        advancedData.FMP = perfEntries === null || perfEntries === void 0 ? void 0 : (_perfEntries$ = perfEntries[0]) === null || _perfEntries$ === void 0 ? void 0 : _perfEntries$.startTime;
        observer.disconnect();
      });
      elementObserve.observe && elementObserve.observe({
        entryTypes: ['element']
      });
      var paintObserve = new PerformanceObserver(function (entryList, observer) {
        var _perfEntries;

        var perfEntries = entryList.getEntries();
        advancedData.LCP = perfEntries === null || perfEntries === void 0 ? void 0 : (_perfEntries = perfEntries[perfEntries.length - 1]) === null || _perfEntries === void 0 ? void 0 : _perfEntries.startTime;
        observer.disconnect();
      });
...
// CONCATENATED MODULE: ./src/lib/performance/longTask.js
...
// CONCATENATED MODULE: ./src/lib/performance/statistics.js
...
function getStatistics() {
  ...
  if (supportPerformanceEntry()) {
    ...
    indicator.JSResourceCount = p.filter(function (ele) {
      return ele.initiatorType === 'script';
    }).length;
    indicator.CSSResourceCount = p.filter(function (ele) {
      return ele.initiatorType === 'css';
    }).length;
    indicator.AJAXRequestCount = p.filter(function (ele) {
      return ele.initiatorType === 'xmlhttprequest';
    }).length;
    indicator.IMGResourceCount = p.filter(function (ele) {
      return ele.initiatorType === 'img';
    }).length;
    indicator.LINKResourceCount = p.filter(function (ele) {
      return ele.initiatorType === 'link';
    }).length;
  }

  return indicator;
}
// CONCATENATED MODULE: ./src/lib/performance/index.js
...
function performance_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

function performance_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { performance_ownKeys(Object(source), true).forEach(function (key) { performance_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { performance_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
function getNavigationTiming() {
  return _getNavigationTiming.apply(this, arguments);
}

function _getNavigationTiming() {
  _getNavigationTiming = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.t0 = performance_objectSpread;
            _context.t1 = performance_objectSpread({}, getNormalNavigationTiming());
            _context.next = 4;
            return getAdvancedNavigationTiming();
...
var es_array_index_of = __webpack_require__(130);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.string.pad-start.js
var es_string_pad_start = __webpack_require__(131);
...
function getDateTime() {
  ...
  return "".concat(currentTime.getFullYear(), "-").concat(String(currentTime.getMonth() + 1).padStart(2, '0'), "-").concat(String(currentTime.getDate()).padStart(2, '0'), " ").concat(String(currentTime.getHours()).padStart(2, '0'), ":").concat(String(currentTime.getMinutes()).padStart(2, '0'), ":").concat(String(currentTime.getSeconds()).padStart(2, '0'), ".").concat(String(currentTime.getMilliseconds()).padStart(3, '0'));
}
...
function substrRes(res) {
  if (typeof res === 'string') {
    if (res.length > 300) {
      return "".concat(res.substr(0, 50), "$......$").concat(res.substring(res.length - 50));
    } else {
      return res;
    }
...
// CONCATENATED MODULE: ./src/lib/network/fetch.js


 // 拦截fetch

function interceptFetch(that) {
  var oldFectch = window.fetch;
  ...
  window.fetch = function (url, options) {
    ...
    return new Promise(function (resolve, reject) {
      oldFectch.apply(_this, _arguments).then(function (response) {
        var oldJson = response.json;

        response.json = function () {
          var result = oldJson.apply(this, arguments);
...
// CONCATENATED MODULE: ./src/lib/network/xhr.js



 // 拦截XMLHttpRequest

function interceptXMLHttpRequest(that) {
  ...
  window.XMLHttpRequest.prototype.send = function () {
    ...
    this.addEventListener('readystatechange', function () {
      if (this.readyState === XMLHttpRequest.DONE) {
        ...
        var isWhite = this.responseURL && !this.responseURL.match(/\/record\/create/) || this.requestURL && !this.requestURL.match(/\/record\/create/);
...
var es_array_reverse = __webpack_require__(135);

// CONCATENATED MODULE: ./src/lib/behavior/index.js
...
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || behavior_unsupportedIterableToArray(arr) || _nonIterableSpread(); }

function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }

function behavior_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return behavior_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return behavior_arrayLikeToArray(o, minLen); }

function _iterableToArray(iter) { if (typeof Symbol !== "undefined" && Symbol.iterator in Object(iter)) return Array.from(iter); }

function _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return behavior_arrayLikeToArray(arr); }

function behavior_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }

/**
 *
 * @desc 记录用户行为的内容，比如输入的内容
 */
function recordBehavior(jarvis) {
  var mouseEventList = ['ontouchstart' in document.documentElement ? 'touchstart' : 'click'];
  var keyboardEventList = ['keydown'];
  var lastEvent = {
    path: '',
    type: '',
    times: 0,
  ...
  mouseEventList.forEach(function (eventType) {
    document.addEventListener(eventType, function (event) {
      var lastActivity = jarvis.activityList.length > 0 ? jarvis.activityList[jarvis.activityList.length - 1] : {};
      var path = getSelectors(event.path);
      var type = event.type;

      if (lastActivity._kind === 'behavior' && lastActivity._type === 'mouse' && lastActivity.path === path && lastActivity.type === type) {
  ...
  keyboardEventList.forEach(function (eventType) {
    document.addEventListener(eventType, function (event) {
      var lastActivity = jarvis.activityList.length > 0 ? jarvis.activityList[jarvis.activityList.length - 1] : {};
      var path = getSelectors(event.path);
      var type = event.type;

      if (lastActivity._kind === 'behavior' && lastActivity._type === 'keyboard' && lastActivity.path === path && lastActivity.type === type) {
        jarvis.activityList.pop();
      } else {
        lastEvent.path = path;
        lastEvent.type = type;
...
function getSelector(path) {
  return path.reverse().filter(function (element) {
    ...
    if (element.id) {
      return "".concat(element.nodeName.toLowerCase(), "#").concat(element.id).concat(getAttributes(element));
    } else if (element.className && typeof element.className === 'string') {
      return "".concat(element.nodeName.toLowerCase(), ".").concat(element.className).concat(getAttributes(element));
    } else {
...
function getAttributes(element) {
  var arr = _toConsumableArray(element.attributes);

  if (arr.length > 0) {
    return arr.reduce(function (a, c) {
      if (c.name !== 'id' && c.name !== 'class' && c.name !== 'style') {
        return a + "[".concat(c.name).concat(c.value ? '=' + c.value : '', "]");
      }
...
// CONCATENATED MODULE: ./src/lib/error/error.js
...
function handleError(that) {
  window.addEventListener('error', function (e) {
    ...
    if (e.__proto__ === Event.prototype) {
      var target = e.target;
      type = resourceError[target.localName]; // 忽略img标签src为空的错误
...
// CONCATENATED MODULE: ./src/lib/error/rejection.js
...
function handleRejection(that) {
  window.addEventListener('unhandledrejection', function (event) {
    ...
    if (typeof reason === 'string') {
      ...
      if (reason.stack) {
        var linesResult = getLines(reason.stack);

        if (linesResult.length > 1) {
          var isFile = linesResult[1].match(/\(/);
          var fileInfo = isFile ? linesResult[1].slice(isFile.index + 1, linesResult[1].length - 1).split(':') : linesResult[1].split(':');
...
// CONCATENATED MODULE: ./src/lib/lifecycle/index.js
...
function onContentLoad(callback) {
...
function onUrlChange(afterChange, beforeChange) {
  // onPushState({ afterChange, beforeChange })
  // onReplaceState({ afterChange, beforeChange })
  // onPopstate(afterChange)
  var interceptHistory = function interceptHistory(type) {
    var oldFunction = history[type];
    return function () {
      afterChange();
      beforeChange();
      var newFunction = oldFunction.apply(this, arguments);
      return newFunction;
    };
  };
...
// CONCATENATED MODULE: ./src/lib/console/index.js




function interceptConsole(that) {
  // 先选这几个方法
  ['log', 'error', 'info', 'warn'].forEach(function (key) {
    var originalFun = console[key];
    ...
    console[key] = function () {
      ...
      originalFun.call.apply(originalFun, [this].concat(args));
    };
  });
}
...
function convert(value) {
  if (value !== undefined && value !== null && !value.toString) {
    return '';
  } else if (typeof value !== 'number' && typeof value !== 'boolean' && typeof value !== 'string' && value !== undefined && value !== null) {
    return value.toString();
  }

  return value;
}
// CONCATENATED MODULE: ./src/lib/network/report.js
...
var src_Jarvis = /*#__PURE__*/function () {
  function Jarvis(_ref) {
    var _this = this;

    var name = _ref.name,
        beforeSend = _ref.beforeSend,
        denyUrls = _ref.denyUrls,
    ...
    src_defineProperty(this, "version", version["a" /* version */]);

    src_defineProperty(this, "uuid", getUUID());

    src_defineProperty(this, "sid", createUUID());

    src_defineProperty(this, "activityList", []);

    src_defineProperty(this, "onContentLoad", function (e) {
      recordBehavior(_this);
      console.log('contentLoad', new Date().getTime());
    });

    src_defineProperty(this, "onLoad", /*#__PURE__*/function () {
      var _ref2 = src_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _this.activityListPush('experience', 'resource', {
              ...
              case 5:
                ...
                _context.t0.activityListPush.call(_context.t0, 'experience', 'timing', _context.t1);
    ...
    src_defineProperty(this, "onBeforeUnLoad", function (e) {
      console.log('beforeUnLoad');
    });

    src_defineProperty(this, "onUnLoad", function (e) {
      console.log('unLoad');

      _this.handlerEnd();
    });

    src_defineProperty(this, "onAfterUrlChange", function (e) {
      _this.sid = createUUID(); // this.handlerEnd()
      // this.init()
    });

    src_defineProperty(this, "onBeforeUrlChange", function (e) {
      /**
      * @todo 单页面上报信息
      */
      // this.handlerEnd()
    ...
    src_defineProperty(this, "handlerEnd", function (e) {
      // 提交队列里的所有数据
      _this.activityListPush('end', 'basic', src_objectSpread({
        endTime: new Date().getTime()
      }, getStatistics()));

      _this.dispatchReport(_this.activityList, null, true);
    });

    src_defineProperty(this, "onVisibilityChange", function (e) {
      _this.activityListPush('behavior', 'visible');
    });

    src_defineProperty(this, "onNetworkChange", function (e) {
      _this.activityListPush('behavior', 'network');
    });

    src_defineProperty(this, "onLongTask", function (e) {
      _this.activityListPush('experience', 'longTask', {
    ...
    src_defineProperty(this, "activityListPush", function () {
      _this.activityList.push(_this.activityItem.apply(_this, arguments));

      if (isDev) {
        console.log(_this.activityList);
      } else {
        if (_this.activityList.length > 30) {
          _this.dispatchReport(_this.activityList, true);
        } else {
          _this.dispatchReport(_this.activityList);
        }
      }
    });

    src_defineProperty(this, "activityListClear", function () {
      _this.activityList = [];
    });

    src_defineProperty(this, "activityItem", function (kind, type, content) {
      return src_objectSpread({
    ...
    onUrlChange(this.onAfterUrlChange, this.onBeforeUrlChange); // 页面状态

    onVisibilitychange(this.onVisibilityChange);
    onNetworkChange(this.onNetworkChange); // 初始化子模块

    handleError(this);
    handleRejection(this);
    interceptXMLHttpRequest(this);
    interceptFetch(this);
  ...
  _createClass(Jarvis, [{
    key: "dispatchReport",
    value: function dispatchReport(data, isNow, isUnLoad) {
      var _this2 = this;

      var temp = data; // cloneDeep(data)
      ...
      if (isUnLoad) {
        ...
        this.timer = setTimeout(function () {
          _this2.sendReport(options);
        }, 3000);
      }
    }
  }, {
    key: "sendReport",
    value: function sendReport(options) {
      reportData(options);
    ...
    key: "vueErrorHandler",
    value: function vueErrorHandler(vm) {
      var _this3 = this;

      vm.config.errorHandler = function (err, vm, info) {
        _this3.activityListPush('error', 'Vue', {
          message: err.message,
...
if (isDev) {
  window.jarvis = new src_Jarvis({
    name: 'test'
  });
}

/* harmony default export */ var src = __webpack_exports__["default"] = (src_Jarvis);

/***/ })
/******/ ])["default"];
});
//# sourceMappingURL=jarvis-sdk.umd.js.map